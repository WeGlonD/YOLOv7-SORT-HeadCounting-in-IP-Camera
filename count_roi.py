...
def is_point_in_roi(point, id):
    x, y = point
    for i, n in enumerate(polygon_lst):
        vertices = np.array(n, np.int32)
        mask = cv2.pointPolygonTest(vertices, (x, y), False)
...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    for line in line_lst:
        cv2.line(img, line[0], line[1], (162,46,112), 3)
    ...
    for i, box in enumerate(bbox):
        ...
        is_point_in_roi(data_deque[id][0], id)
